...
<!-- CLF Stylesheets -->
  <link_DISABLED href="//hours.library.ualberta.ca/css/ubc-clf-full.min.css" rel="stylesheet" />
 ...
 <body>
    ...
    <div class="container-fluid banner-container"><!-- Logo, banner, ask-us and mobile navigation -->
          ...
          <div class="col-sm-6 col-xs-7">
            <h1>
              <a href="https://library.ualberta.ca">
                <img src="https://web.library.ualberta.ca/img/ualib-logo-sm.png" class="ua-logo" alt="Univerity of Alberta Libraries Logo">
              </a>
            </h1>
          </div>
      ...
      <div id="navbar" class="col-xs-10 collapse" style="height: 0px;"><!-- Mobile menu -->
        <ul>
          <li class="active"><a href="https://www.library.ualberta.ca">Search &amp; Home</a></li>        
          <li><a href="//www.library.ualberta.ca#services">Services</a></li>
          <li><a href="//www.library.ualberta.ca#subjects-pane">Subject Guides</a></li>
          <li><a href="https://www.library.ualberta.ca#news-pane">News &amp; Events</a></li>
          <li><a href="//www.library.ualberta.ca#research">Research Support</a></li>
          <li><a href="https://www.library.ualberta.ca/myaccount/">My Account</a></li>
          <li><a href="http://www.ualberta.ca">University of Alberta Home</a></li>
        </ul>
      </div><!-- End mobile menu -->
          ...
          <div class="row">
            <ul class="lib-nav">
              ...
              <li id="news" class="col-sm-2">
                <a href="//www.library.ualberta.ca/#news-pane"><span></span>News &amp; Events</a>
              </li>
              <li id="services" class="col-sm-2">
                <a href="//www.library.ualberta.ca/#services"><span></span>Services</a>
              </li>
              <li id="subjects" class="col-sm-2">
                <a href="//www.library.ualberta.ca/#subjects-pane"><span></span>Subject Guides</a>
              </li>
              <li id="research" class="col-sm-2">
                <a href="//www.library.ualberta.ca#research"><span></span>Research Support</a>
              </li>
              <li id="account" class="col-sm-2">
                <a href="https://www.library.ualberta.ca/myaccount/"><span></span>My Account</a>
              </li>
            </ul>
          </div>
        </div>
